...
| Fullscreen mouse interaction | Tool card/group click-to-toggle, previews, hover highlight, and a back-to-bottom button | `/ccstyle` (requires official fullscreen TUI: enable via `/settings` or `--tui-mode fullscreen`) |
