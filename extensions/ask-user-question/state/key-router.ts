...
export function routeKey(
	...
	// focused in the temporary editor slot and shrinks to one row, so the same key
	// can expand it without a raw terminal listener.
	//
	...
	// and the legacy telnet/ssh escape role doesn't apply because the questionnaire runs
